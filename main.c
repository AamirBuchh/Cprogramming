...
int main()
{
    ...
    */
    ...
    // printf("\n\n*****Taking input from c*****\n");
    // int aamirInput;
    // printf("\nPlease enter the value of aamirInput:");
    // scanf("%d",&aamirInput);
    // // printf("\nYou entered input as : %d \n\n",(float)aamirInput);
    // printf("\nThe value of int converted into float : %0.3f\n",(float)aamirInput);
    ...
    // int alpha;
    // printf('\nEnter to alphabets to print from A to D in upper case only : ');
    // scanf("%d", &alpha);
    // printf(alpha);
    // switch (alpha)
    // {
